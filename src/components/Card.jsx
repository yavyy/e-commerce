      ...
      <section className='mt-2 p-3'>
        ...
        <div className='flex flex-col lg:flex-row justify-between items-center md:gap-4'>
          ...
          <div className='flex items-center flex-col xl:flex-row gap-2'>
            <button onClick={() => navigate(`/product/${product.id}`)} className='bg-gray-700 text-white text-sm rounded px-4 py-2 cursor-pointer tracking-tighter hover:bg-gray-800 active:scale-95 transition'>View Details</button>
